...
fn update_dial_position(
  ...
  let new_dial_position =
    ...
    % dial_position_max
  let new_dial_position_zero_count = case new_dial_position {
    0 -> state.dial_position_zero_count + 1
    _ -> state.dial_position_zero_count
  }
  State(
    stream: state.stream,
    dial_position: new_dial_position,
    dial_position_zero_count: new_dial_position_zero_count,
  )
}
...
pub fn part_1_example_test() {
  ...
  assert state.dial_position_zero_count == 3
}
...
pub fn part_1_test() {
  ...
  assert state.dial_position_zero_count == 1040
}
